...
class MainWindow(QMainWindow):
    ...
    def setUpMainWindow(self):
        ...
        info_label = QLabel("Click on the button and select the fruid.")
        info_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        
        self.images = ["./images/1_apple.png", "./images/2_pineapple.png",
        ...
        container = QWidget()
        container.setLayout(main_v_box) # Because the MainWindow inherit from QMainWindow not QWidgets so u have use container
