...
class MainWindow(QMainWindow):
    ...
    def openFile(self):
        """Open a text or html file and display its contents in the text
        edit filed."""
    ...
    def saveToFile(self):
        ...
        in the tex edit field to a text or rich text file."""
    ...
    def searchText(self):
        ...
        if ok:
            ...
            self.text_edit.setExtraSelections(extra_selections) # Highlights all selections
