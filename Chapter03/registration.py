...
class NewUserDialog(QDialog):
    ...
    def setUpWindow(self):
        ...
        self.new_pswd_edit.move(100, 200)
        ...
        self.confirm_edit.move(100, 230)
    ...
    def confirmSignUp(self):
        """Check if user information is enterd and correct.
        ...
        if name_text == "" or pswd_text == "":
            ...
            # Return to loging window if passwords match
